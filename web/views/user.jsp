	...
	<div data-options="region:'east',split:true,collapsed:true,title:'管理操作'" style="background:#0f66ab;width:200px;padding:10px">
        ...
        <form id="addUserForm"  method="post" enctype="multipart/form-data"<%--上传图片--%>>
            ...
            <table>
                <tr>
                    <td>用户ID:</td>
                    <td><input  id="a_id" class="easyui-textbox" type="text" autocomplete="off" name="id" data-options="required:true,novalidate:true"></input></td>
                </tr>
                <tr>
                    <td>权限等级:</td>
                    <td><select id="a_p_id" class="easyui-combobox" name="p_id" data-options="required:true"style="width:100%">
        ...
        <form id="editUserForm"  method="post" enctype="multipart/form-data"<%--上传图片--%>>
            ...
            <table>
                <tr>
                    <td>用户ID:</td>
                    <td><input readonly id="u_id" class="easyui-textbox" type="text" autocomplete="off" name="id" data-options="required:true"></input></td>
                </tr>
                 <tr>
                    <td>用户昵称:</td>
                    <td><input readonly id="u_name" class="easyui-textbox" type="text" autocomplete="off" name="name" data-options="required:true"></input></td>
                </tr>
                <tr>
                    <td>权限等级:</td>
